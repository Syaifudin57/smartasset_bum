            ...
            <div class="col-md-3">
                <div class="box">
                    <div class="box-body box-profile">
                        ...
                        <a href="<?= base_url('auth/logout') ?>" class="btn btn-primary btn-block tombol-yakin" data-isidata="Ingin keluar dari sistem ini?">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#account" data-toggle="tab">
                                <div class="fa fa-user"></div> Account
                            </a></li>
                        <li><a href="#log" data-toggle="tab">
                                <div class="fa fa-history"></div> Log Status
                            </a></li>
                    </ul>
