    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url('home') ?>" class="logo">
                ...
                <span class="logo-lg">
                    <?php if (!empty($aplikasi['logo'])) { ?>
                        <img src="<?= base_url('assets/logo/' . $aplikasi['logo']) ?>" alt="Logo" style="height:30px; vertical-align:middle; margin-right:8px;">
                    <?php } ?>
                    <b><?= $this->session->userdata('level') ?></b>
                </span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?= base_url('auth/logout') ?>" class="btn btn-default btn-flat tombol-yakin" data-isidata="Ingin keluar dari sistem ini?">
